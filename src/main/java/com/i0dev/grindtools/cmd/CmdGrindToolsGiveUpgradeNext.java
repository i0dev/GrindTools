...
public class CmdGrindToolsGiveUpgradeNext extends GrindToolsCommand {

    public CmdGrindToolsGiveUpgradeNext() {
        this.addParameter(TypePlayer.get(), "player");
        this.addParameter(TypeUpgradeNext.get(), "upgrade");
    ...
    public void perform() throws MassiveException {
        ...
        TierUpgradeNext upgrade = this.readArgAt(1);
